...
using L01P022022QR601.Models;

namespace L01P022022QR601.Controllers
{
    public class departamentosController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.departamentos != null ? 
                          ...
                          Problem("Entity set 'notasDbContext.departamentos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'notasDbContext.departamentos'  is null.");
            }
            var departamentos = await _context.departamentos.FindAsync(id);
            if (departamentos != null)
            {
